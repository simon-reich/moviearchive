...
const departments: DepartmentData[] = [
  { 'type': Departments.Editing, 'data': [] },
  { 'type': Departments.Camera, 'data': [] },
  { 'type': Departments.Sound, 'data': [] },
  { 'type': Departments.Costume, 'data': [] },
  { 'type': Departments.Art, 'data': [] },
  { 'type': Departments.Vfx, 'data': [] },
  { 'type': Departments.Lighting, 'data': [] },
  { 'type': Departments.Crew, 'data': [] },
]
